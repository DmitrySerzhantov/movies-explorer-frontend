      ...
      <div className='container'>
        ...
        <div className='about-project__nav'>
          <figure className='about-project__nav-item'>
            <button className='about-project__nav-button about-project__nav-button_style_green'>
              1 неделя
            </button>
          ...
          <figure className='about-project__nav-item'>
            <button className='about-project__nav-button about-project__nav-button_style_black'>
              4 недели
            </button>
            <figcaption className='about-project__nav-caption'>
              Front-end
